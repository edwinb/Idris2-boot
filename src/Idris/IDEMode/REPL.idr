...
displayIDEResult outf i  (ChangedDirectory dir) = printIDEResult outf i $ StringAtom $ "Changed working directory to '" ++ dir ++ "'"
displayIDEResult outf i  (WorkingDirectory dir) = printIDEResult outf i $ StringAtom $ "Current working directory is '" ++ dir ++ "'"
